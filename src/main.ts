...
if (savedAdmin) {
  try {
    ...
    if (!state.admin.scores) state.admin.scores = defaultScores
  } catch (e) {}
}
  ...
  ;(window as any).fullReset = () => {
    if (confirm('Resetar tudo?')) {
      ...
      state = {
        ...
        simpleData: { absences: [], warnings: [], quartile4: false, absencesIndeterminate: 0 },
      ...
      <div class="card-section">
        ...
        <div class="grid-2">
          <div>
            ...
            <strong>Setor:</strong> ${state.setor}<br>
